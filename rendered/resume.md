...
- Deployed the LiteLLM proxy in K8s to make our AI integrations provider-agnostic, reducing vendor lock-in as AI models and pricing changes rapidly.
- Utilized LiteLLM architecture to formally benchmark leading AI models standalone vs within our product, showing how our harness lifts accuracy across models to support Marketing's buy-vs-build case.
...
- Productionalized local dev utilizing direnv / nix / Justfile so each repo works out of the box for a new hire with a single command.
...
- Utilized AI coding tools (Claude Code and Cursor) to rapidly implement solutions and triage incidents.
